...
zoomSlider = tk.Scale(root, from_=1, to=200, resolution=0.1, orient="horizontal", label="Zoom")
zoomSlider.set(1)
zoomSlider.pack()
...
detailSlider1 = tk.Scale(root, from_=1, to=200, resolution=1, orient="horizontal", label="Detail")
detailSlider1.set(40)
detailSlider1.pack()

detailSlider2 = tk.Scale(root, from_=1, to=10, resolution=1, orient="horizontal", label="Detail")
detailSlider2.set(5)
detailSlider2.pack()
    ...
    for i in range(detail):
        ...
        for j in range(detail):
            ...
            for a in range(tries):
                ...
                t.dot(max(3,screenScaleX / (zoomSlider.get() * detail / 5.5)), "#000000")
                functionsUsed += 1
